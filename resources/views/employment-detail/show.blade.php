        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <div id="sensitive-section" class="{{ $verified ? '' : 'blurred position-relative' }}">
                    ...
                    <!-- Informasi Data Diri -->
                    <h5 class="fw-bold mb-3">Informasi Data Diri</h5>
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <p><strong>Employee Number :</strong> {{ $user->employmentDetail->employee_number ?? 'N/A' }}
                            </p>
                            <p><strong>Tanggal Lahir :</strong> {{ $user->birth_date?->format('d F Y') ?? 'Belum Diisi' }}
                            </p>
                            <p><strong>Alamat :</strong> {{ $user->address }}</p>
                        </div>
                        <div class="col-md-6">
                            <p><strong>Gender :</strong> {{ $user->gender }}</p>
                            <p><strong>Status Perkawinan :</strong> {{ $user->marital_status }}</p>
                        </div>
                    </div>
                    ...
                    <h5 class="fw-bold">Riwayat Pendidikan & Diklat</h5>
                    ...
                    <div class="tab-content mt-3">
                        <div class="tab-pane fade show active" id="education" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if (Auth::id() == $user->id || Auth::user()->isAdmin() || Auth::user()->isHRD())
