...
@section('content')
    ...
    <form action="{{ route('meetings.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="time" name="meeting_start_time" id="meeting_start_time" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="meeting_end_time">Jam Selesai</label>
            <input type="time" name="meeting_end_time" id="meeting_end_time" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <trix-editor input="meeting_result" class="trix-content" required></trix-editor>
