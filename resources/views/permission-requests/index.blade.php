...
@section('content')
    <div class="container">
        @foreach ($permissionRequests as $unitName => $requests)
            <h1>Daftar Permohonan Surat Izin/Surat Sakit - {{ $unitName }}</h1>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        @can('delete', $data)
                                            <li>
                                                <form action="{{ route('permissionrequest.destroy', $data->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                        ...
                                        <li>
                                            <button type="button" title="Lihat Detail" class="btn btn-info text-white"
                                                ...
                                                data-bs-target="#permissionRequests{{ $data->id }}">
                                                <i class="bi bi-eye"></i>
                                            </button>
