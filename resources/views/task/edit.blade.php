                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="place" type="text"
                                        ...
                                        value="{{ old('place', $task->place) }}" required autocomplete="place" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="task_date" type="date"
                                        ...
                                        value="{{ old('task_date', $task->task_date) }}" required autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="task_start_time" type="time"
                                        ...
                                        name="task_start_time" value="{{ old('task_start_time', $task->task_start_time) }}"
                                        required autocomplete="task_start_time" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="task_end_time" type="time"
                                        ...
                                        name="task_end_time" value="{{ old('task_end_time', $task->task_end_time) }}"
                                        required autocomplete="task_end_time" autofocus>
